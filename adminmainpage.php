				...
				<div class="divt" style="height:130px;margin-left:250px;">
    				<div class="col-md-12">
    					<div class="row">
    						<div class="col-md-8">
                                <?php
                                $re = mysqli_query($conn,"SELECT * FROM lectdetails");
							...
							<div class="col-md-4">
    							<a href="lecturedetails.php" ><img src="images/lecticon1.png" style="border-color: rgb(224, 37, 54 ,0.0);margin-top:-20px;width:100px;opacity: 0.95;height:100px;box-shadow: -2px 2px 2px -2px black;border-radius:55px 55px;" alt="Click here"> </a>
    						</div>
				...
				<div class="divt" style="height:130px;margin-top:-130px;margin-left:800px;">
    				<div class="col-md-12">
    					<div class="row">
    						<div class="col-md-8">
                                <?php
                                $re = mysqli_query($conn,"SELECT * FROM studentdetails");
                                $rep = mysqli_num_rows($re);
                                ?>
    							<h5 class="my-2 text-white text-center" style="font-size: 30px;"><?php echo $rep;?></h5>
    							<h5 class="text-white ">Total</h5>
